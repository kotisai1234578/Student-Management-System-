...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> anyException(CategoryException ex, WebRequest req){
	...
	public ResponseEntity<MyErrorDetails> anyException(ProductException ex, WebRequest req){
	...
	public ResponseEntity<MyErrorDetails> anyException(Exception ex, WebRequest req){
